...
public class PokeComputerScreen extends SimpleScreen implements KeyHandable {
	...
	/*
	 * Metodo utilizado para cambiar las imagenes de los Pokemon disponibles en
	 * el PC segun la pagina actual, debe obtener entre 1 y 18 elementos del
	 * arreglo backupImages, modificar los atributos de los anteriores Pokemon a
	 * no visibles y poner los nuevos elementos en estado visible.
	 */
	 ...
	 * minimo entre el tama�o del arreglo de Backup Pokemon y el limite superior
