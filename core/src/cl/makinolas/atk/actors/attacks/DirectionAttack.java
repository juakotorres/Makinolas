...
public class DirectionAttack extends ShootAttack {
    ...
    public DirectionAttack(SpriteState spriteState, World myWorld, float x, float y, float x2, float y2, float speed, Monsters source, IType type) {
        super(spriteState, myWorld, x, y, (x2-x) > 0, source, type);
