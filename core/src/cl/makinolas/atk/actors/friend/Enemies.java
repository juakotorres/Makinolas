...
public enum Enemies {
  ...
  SANDSHREW(60, 255, 50, 75, 85, 20, 30, 40),
  SANDSLASH(158, 90, 75, 100, 110, 45, 55, 65),
  VULPIX(60, 190, 38, 41, 40, 50, 65, 65),
  NINETALES(177, 75, 73, 76, 75, 81, 100, 100),
  ...
  GROWLITHE(70, 190, 55, 70, 45, 70, 50, 60),
  ARCANINE(194, 75, 90, 110, 80, 100, 80, 95),
  GEODUDE(60, 255, 40, 80, 100, 30, 30, 20),
  GRAVELER(137, 120, 55, 95, 115, 45, 45, 35),
  GOLEM(218, 45, 80, 120, 130, 55, 65, 45),
  ...
  MAGIKARP(40, 255, 20, 10, 55, 15, 20, 80),
  GYARADOS(189, 45, 95, 125, 79, 60, 100, 81),
  ...
  SPIRITOMB(170, 100, 50, 92, 108, 92, 108, 35),
  GIBLE(60, 45, 58, 70, 45, 40, 45, 42),
  GABITE(144, 45, 68, 90, 65, 50, 55, 82),
  GARCHOMP(270, 45, 108, 130, 95, 80, 85, 102),
  SKORUPI(66, 120, 40, 50, 90, 30, 55, 65),
  DRAPION(175, 45, 70, 90, 110, 60, 75, 95),
  MAGNEZONE(241, 30, 70, 70, 115, 130, 90, 60),
  GLISCOR(179, 30, 75, 95, 125, 45, 75, 95),
  ...
  /* agregados */
  LARVITAR(60, 45, 50, 64, 50, 45, 50, 41),
  PUPITAR(144, 45, 70, 84, 70, 65, 70, 51),
  TYRANITAR(270, 45, 100, 134, 110, 95, 100, 61),
  AXEW(60, 75, 46, 87, 60, 30, 40, 57),
  FRAXURE(144, 60, 66, 117, 70, 40, 50, 67),
  HAXORUS(270, 45, 76, 147, 90, 60, 70, 97);
